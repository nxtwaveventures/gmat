...
export async function GET() {
    try {
        ...
        // 3. Create GMAT Quantitative questions at different difficulty levels
        const questions = [
            {
            ...
            },
            {
                ...
                solution: 'B',
                explanation: 'The sequence adds 2 each time: 2, 4, 6, 8, so the next number is 8 + 2 = 10.',
            },
            {
                examType: 'GMAT' as ExamType,
                section: 'QUANTITATIVE' as Section,
            ...
            },
            {
                ...
                solution: 'E',
                explanation: 'Let the integers be x, x+1, and x+2. Then x + (x+1) + (x+2) = 51 → 3x + 3 = 51 → 3x = 48 → x = 16. So the integers are 16, 17, and 18. The product of smallest and largest is 16 × 18 = 288.',
            },
            {
                examType: 'GMAT' as ExamType,
                section: 'QUANTITATIVE' as Section,
                ...
                solution: 'D',
                explanation: 'Substituting x = -1 into both equations gives 1 - b + c = 0 and 1 - c + b = 0. Adding these equations: 2 = 0, which means b + c = 2.',
            },
        ];
        ...
        return NextResponse.json({
            success: true,
            message: `Successfully seeded demo user and ${questions.length} GMAT Quantitative questions`
        });
    } catch (error) {
