...
export default function GMATStatisticsPage() {
    return (
        <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
                    <div className="text-center">
                        ...
                        <p className="mt-6 text-xl text-blue-100 max-w-3xl mx-auto">
                            Master statistical concepts and probability for GMAT success.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                {/* Overview Section */}
                <div className="mb-16">
                    <h2 className="text-3xl font-bold text-gray-900 mb-8">Statistics Overview</h2>
                ...
                <div className="mb-16">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <Card className="bg-white shadow-lg">
                            ...
                            <div className="p-6 pt-0">
                                <Button variant="default" size="lg" asChild className="w-full">
                                    <Link href="/gmat/quantitative/problem-solving/statistics/descriptive">Start Learning</Link>
                                </Button>
                            </div>
                        </Card>
                        ...
                        <Card className="bg-white shadow-lg">
                            ...
                            <div className="p-6 pt-0">
                                <Button variant="default" size="lg" asChild className="w-full">
                                    <Link href="/gmat/quantitative/problem-solving/statistics/probability">Start Learning</Link>
                                </Button>
                            </div>
                        </Card>
                        ...
                        <Card className="bg-white shadow-lg">
                            ...
                            <div className="p-6 pt-0">
                                <Button variant="default" size="lg" asChild className="w-full">
                                    <Link href="/gmat/quantitative/problem-solving/statistics/permutations">Start Learning</Link>
                                </Button>
                            </div>
                        </Card>
                        ...
                        <Card className="bg-white shadow-lg">
                            ...
                            <CardContent>
                                <ul className="space-y-2 text-sm text-gray-600">
                                    <li>• Basic Combinations</li>
                                    <li>• Selection Problems</li>
                                    <li>• Restrictions</li>
                                    <li>• Applications</li>
                                </ul>
                            </CardContent>
                            <div className="p-6 pt-0">
                                <Button variant="default" size="lg" asChild className="w-full">
                                    <Link href="/gmat/quantitative/problem-solving/statistics/combinations">Start Learning</Link>
                                </Button>
                            </div>
                        </Card>
                    </div>
                ...
                <div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <Card className="bg-white shadow-lg">
                            ...
                            <div className="p-6 pt-0">
                                <Button variant="premium" size="lg" asChild className="w-full">
                                    <Link href="/gmat/quantitative/problem-solving/statistics/topic-practice">Start Practice</Link>
                                </Button>
                            </div>
                        </Card>
                        ...
                        <Card className="bg-white shadow-lg">
                            ...
                            <div className="p-6 pt-0">
                                <Button variant="premium" size="lg" asChild className="w-full">
                                    <Link href="/gmat/quantitative/problem-solving/statistics/mixed-practice">Start Practice</Link>
                                </Button>
                            </div>
                        </Card>
                    </div>
