...
export default function WeightedAverageBasicPage() {
    return (
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
                    <div className="text-center">
                        ...
                        <p className="mt-6 text-xl text-blue-100 max-w-3xl mx-auto">
                            Master the fundamental formula and applications of weighted averages.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                ...
                <div className="mb-16">
                    ...
                    <Card className="bg-white shadow-lg">
                        <CardHeader>
                            <CardTitle>Basic Weighted Average Formula</CardTitle>
                            <CardDescription>
                        ...
                        <CardContent>
                            <div className="space-y-4">
                                <div className="bg-blue-50 p-4 rounded-lg">
                                    <h3 className="font-bold text-lg mb-2">Weighted Average Formula:</h3>
                                    <p className="text-gray-700 mb-4">
                                        Weighted Average = (Sum of (Value × Weight)) ÷ (Sum of Weights)
                                    </p>
                                    <h3 className="font-bold text-lg mb-2">Key Components:</h3>
                                    <ul className="list-disc pl-5 space-y-2 text-gray-700">
                                        <li>Value: The number being weighted</li>
                                        <li>Weight: The importance or frequency of the value</li>
                                        <li>Sum of Products: Multiply each value by its weight and add them</li>
                                        <li>Sum of Weights: Add all the weights together</li>
                                    </ul>
                                </div>
                                ...
                                <Card key={num} className="bg-white shadow-lg">
                                    ...
                                    <CardContent>
                                        ...
                                        <Button variant="default" size="lg" asChild className="w-full">
                                            <Link href={`/gmat/quantitative/problem-solving/statistics/descriptive/central-tendency/weighted-average/basic/question/${num}`}>
                                                Start Practice
                                            </Link>
                                        </Button>
                                    </CardContent>
